...
const posts: Record<string, Post> = {
  ...
  ['234567']: {
    ...
    content: `Getting enough sleep is crucial for maintaining good health and well-being. Sleep is essential for our bodies to repair and regenerate, and it plays a critical role in many bodily functions.
      
      Sleep is important for physical health, as it helps to support the immune system and repair tissues and cells in the body. During sleep, the body produces cytokines, which are proteins that help to fight infections and inflammation. Additionally, sleep is important for maintaining a healthy weight, as lack of sleep can disrupt the hormones that regulate appetite and metabolism.
      
      Sleep also plays a critical role in mental health. It is essential for emotional well-being, as lack of sleep can contribute to anxiety, depression, and irritability. Sleep is also important for cognitive function, as it helps to consolidate memories and improve learning and problem-solving abilities.
      
      Getting enough sleep is important for optimal performance, both physically and mentally. Lack of sleep can impair physical performance, as it can reduce endurance, strength, and coordination. It can also affect mental performance, including reaction time, attention, and decision-making abilities. On the other hand, getting enough sleep can improve performance in all areas, making it a key factor in achieving success and reaching our goals.`,
    date: '2021-01-02',
    author: 'John Doe',
  },
  ['345678']: {
